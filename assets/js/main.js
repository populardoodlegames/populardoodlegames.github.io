...
// Particle background injection at the very start of body
function injectParticlesBackground() {
  if (!document.getElementById('particles-js')) {
    ...
    script.onload = function() {
      window.particlesJS && window.particlesJS.load('particles-js', '/assets/particlesjs-config.json');
    };
    document.body.appendChild(script);
  }
}

// Ad script injection into correct containers
function injectAdScript(selector, adHtml) {
